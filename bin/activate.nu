...
let virtual-env = "/run/media/importante/proyectos/pyqt6-tutorials"
let bin = "bin"
let path-sep = ":"
...
alias deactivate = source "/run/media/importante/proyectos/pyqt6-tutorials/bin/deactivate.nu"
